...
public class FreightCar extends Car {
    ...
    public FreightCar(int priceAuto, int averageSpeedAuto, Classification classification, Model model, int fuelConsumer, int capacityOfPeopleInTheCar, int loadCapacity) {
